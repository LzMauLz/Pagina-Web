...
let agregarCarrtioBtns= document.querySelectorAll('.product .agregar-carrito, .product2 .agregar-carrito')
...
function comprarElemento(e) {
    ...
    if(e.target.classList.contains('agregar-carrito')) {
        const elemento = e.target.closest('.product, .product2');
...
function actualizarBotones(){
    ...
    agregarCarrtioBtns = document.querySelectorAll('.product .agregar-carrito, .product2 .agregar-carrito');
